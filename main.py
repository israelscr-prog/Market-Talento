"""
main.py - Punto de entrada principal del sistema de inventario.
Uso: py -3.11 main.py
"""
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body d-grid gap-2">
                    <button class="btn btn-primary"   onclick="callAPI('/api/test')">GET /api/test</button>
                    <button class="btn btn-success"   onclick="callAPI('/api/analizar')">GET /api/analizar</button>
                    <button class="btn btn-info"      onclick="callAPI('/api/productos')">GET /api/productos</button>
                    <button class="btn btn-warning"   onclick="callAPI('/api/producto/Leche')">GET /api/producto/Leche</button>
                    <button class="btn btn-secondary" onclick="callAPI('/api/recomendaciones')">GET /api/recomendaciones</button>
                </div>
            </div>
        </div>
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="response" class="response-area">Haz clic en un endpoint...</div>
                </div>
            </div>
        </div>
    </div>
...
if __name__ == "__main__":
    print("=" * 50)
    print("  INVENTARIO INTELIGENTE — VERSION REFACTORIZADA")
